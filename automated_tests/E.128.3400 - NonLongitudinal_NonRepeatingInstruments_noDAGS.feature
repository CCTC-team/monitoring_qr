Feature: E.128.3400 - NonLongitudinal_NonRepeatingInstruments_noDAGS
  ...
  Scenario: Enable external module in project
    Given I create a new project named "E.128.3400" by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "fixtures/cdisc_files/redcap_val/ProjectTypes/NonLongitudinal_NonRepeatingInstruments_noDAGS.xml", and clicking the "Create Project" button
