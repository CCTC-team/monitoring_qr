Feature: E.128.2600 - NonRepeating_SingleArm_noDAGs
  ...
  Scenario: Enable external module in project
    Given I create a new project named "E.128.2600" by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "fixtures/cdisc_files/ProjectTypes/NonRepeating_SingleArm_noDAGs.xml", and clicking the "Create Project" button
  ...
  Scenario: E.128.100 - Disable external module
    ...
    And I should NOT see "E.128.2600"
